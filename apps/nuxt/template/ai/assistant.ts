import {type AssistantStreamEvent } from "https://esm.sh/openai/resources/beta";
import {type RunCreateParamsBaseStream} from "https://esm.sh/openai/src/lib/AssistantStream";
