import { ChatOpenAI, OpenAIEmbeddings } from 'https://esm.sh/@langchain/openai';
import { baseUrl, tokenService} from "../../sap-ai-token";
 
export const langchain =async (options?: ConstructorParameters<typeof ChatOpenAI>[0] , env ={}) => {
