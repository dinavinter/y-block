...
export class TypescriptProject {
    ...
    private async init(): Promise<void> {
        ...
        system.createDirectory("xstate");
        await this.fs.forFileInLib('xstate', (name, content) => { 
            system.writeFile(path.join("xstate", name, content))  
        })
        

        console.log("directoryExists" ,system.directoryExists("xstate"))
